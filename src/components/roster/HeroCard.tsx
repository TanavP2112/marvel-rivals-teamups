...
import { ROLE_BG_CLASS, ROLE_ICON, ROLE_TEXT_CLASS, ROLE_LABEL } from '@/constants/roles'
...
export function HeroCard({ hero, onSelect }: HeroCardProps) {
  return (
    ...
    >
      <span className={clsx('absolute inset-x-0 top-0 h-[3px]', ROLE_BG_CLASS[hero.role])} />
      ...
      <div className={clsx('text-[11px] font-extrabold uppercase tracking-wide', ROLE_TEXT_CLASS[hero.role])}>
